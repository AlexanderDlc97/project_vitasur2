    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin-cobros.resultadosEXCEL') }}" method="POST">
                @csrf  
                    <div class="my-3" id="">
                ...
                {{-- <a href="{{ route('admin-cobros.resultadosEXCELshow') }}" class="border border-dark text-secondary btn w-100 mt-3">Descargar Todo</a> --}}
            </div>
        </div>
    </div>
</div>