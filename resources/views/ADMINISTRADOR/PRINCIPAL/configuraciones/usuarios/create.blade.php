...
{{-- Contenido --}}
<form method="POST" action="{{ route('admin-usuarios.store') }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>
    @csrf
    <div class="container-fluid">   
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-2 col-lg-2">
                        ...
                        <select name="cargo_id" id="cargo__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            <option value="{{ old('cargo_id') }}" selected="selected" hidden="hidden">{{ old('cargo_id') }}</option>
