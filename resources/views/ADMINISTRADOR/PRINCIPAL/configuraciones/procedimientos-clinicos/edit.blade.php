...
<div class="modal fade" id="edit_procedimientoc{{ $admin_procedimientoclinico->slug }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('admin-procedimientosclinicos.update', $admin_procedimientoclinico->slug) }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>      
                @csrf    
                @method('put')
                <div class="card border-0 rounded-0 border-start border-3 border-info mb-4" style="box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px; background-color: #f6f6f6">
                    ...
                    <div class="mb-2">
                        ...
                        <select name="tipo" id="tipo_id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            <option value="{{ $admin_procedimientoclinico->tipo }}" selected="selected" hidden="hidden">{{ $admin_procedimientoclinico->tipo }}</option>
                    ...
                    <div class="mb-2">
                        ...
                        <input name="name" value="{{ $admin_procedimientoclinico->name }}" id="name__id" type="text" class="form-control" required>
                        @error('name')
                    ...
                    <div class="mb-2">
                        ...
                        <input name="costo" id="costo__id" type="decimal" class="form-control" value="{{ $admin_procedimientoclinico->costo }}">
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
