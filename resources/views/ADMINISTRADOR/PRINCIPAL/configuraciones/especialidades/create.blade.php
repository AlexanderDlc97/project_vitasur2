<form method="POST" action="{{ route('admin-especialidades.store') }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>      
    @csrf    
    <div class="modal fade" id="createespecialidad" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <select name="profesione_id" id="profesione_id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            <option value="{{ old('profesione_id') }}" selected="selected" hidden="hidden">{{ old('profesione_id') }}</option>
