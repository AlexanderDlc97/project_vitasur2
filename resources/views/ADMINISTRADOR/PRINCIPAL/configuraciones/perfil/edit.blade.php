...
{{-- Contenido --}}
<form method="POST" action="{{ route('admin-perfil.update',$admin_perfil->slug) }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>
    @csrf
    @method('put')
    <div class="container-fluid">   
            ...
            <div class="card-body">
                <div class="row g-3 mb-3">
                    <div class="col-12 col-md-3 col-lg-2 order-2 order-md-1">
                        @if($admin_perfil->imagen == 'NULL')
                            <img for="uploadImage1" id="uploadPreview1" alt="" class="rounded imagecard" src="/images/icon-photo.png">
                        @else
                            <img for="uploadImage1" id="uploadPreview1" alt="" class="rounded imagecard" src="/images/personas/{{ $admin_perfil->imagen }}">   
                        @endif
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-2 col-lg-2">
                        @if(Auth::user()->role_id == '2')
                            ...
                            <select name="profesion_id" id="profesion__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                                @foreach($profesiones as $profesion)
                                    <option value="{{ $profesion->id }}" @if( $admin_perfil->medico->profesion_id == $profesion->id) selected="selected" @endif>{{ $profesion->name }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
                                El campo no puede estar vacío
                        ...
                        @else
                            ...
                            <select name="cargo_id" id="cargo__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                                @foreach($roles as $role)
                                    <option value="{{ $role->id }}" @if( $admin_perfil->user->role_id == $role->id) selected="selected" @endif>{{ $role->name }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
                                El campo no puede estar vacío
                    ...
                    <div class="col-12 col-md-5 col-lg-5">
                        ...
                        <input name="name" id="name_id" type="text" class="form-control" value="{{ $admin_perfil->name }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-5 col-lg-5">
                        ...
                        <input name="surnames" id="surnames_id" type="text" class="form-control" value="{{ $admin_perfil->surnames }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <select name="identificacion" id="identificacion__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            @foreach($identificaciones as $identificacion)
                                <option value="{{ $identificacion->abreviatura }}"  @if( $admin_perfil->identificacion == $identificacion->abreviatura) selected="selected" @endif>{{ $identificacion->name }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                    ...
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <input name="nro_identificacion" id="nro_identificacion_id" type="number" class="form-control" value="{{ $admin_perfil->nro_identificacion }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <input name="nro_contacto" id="nro_contacto_id" type="number" class="form-control" value="{{ $admin_perfil->nro_contacto }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-2">
                        <label for="fecha_nacimiento_id">Fecha de Nacimiento</label>
                        <input name="fecha_nacimiento" id="fecha_nacimiento_id" type="date" class="form-control" value="{{ $admin_perfil->fecha_nacimiento }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <select name="sexo" id="sexo__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            <option value="Hombre" @if( $admin_perfil->sexo == "Hombre") selected="selected" @endif>Hombre</option>
                            <option value="Mujer" @if( $admin_perfil->sexo == "Mujer") selected="selected" @endif>Mujer</option>
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <select name="estado_civil" id="estado_civil__id" class="form-select select2_bootstrap" data-placeholder="Seleccione" required>
                            <option value="Soltero" @if( $admin_perfil->estado_civil == "Soltero") selected="selected" @endif>Soltero</option>
                            <option value="Casado" @if( $admin_perfil->estado_civil == "Casado") selected="selected" @endif>Casado</option>
                            <option value="Divorciado" @if( $admin_perfil->estado_civil == "Divorciado") selected="selected" @endif>Divorciado</option>
                            <option value="Viudo" @if( $admin_perfil->estado_civil == "Viudo") selected="selected" @endif>Viudo</option>
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        ...
                        <input name="direccion" id="direccion_id" type="text" class="form-control" value="{{ $admin_perfil->direccion }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        ...
                        <input name="referencia" id="referencia__id" type="text" class="form-control" value="{{ $admin_perfil->referencia }}">
                    </div>
                </div>

                <div class="form-check mb-2 mt-3">
                    <input class="form-check-input" type="checkbox" name="credenciales" value="Si" id="check_credenciales" @if ($admin_perfil->user) checked @endif >
                ...
                @else
                    <div class="row g-3" id="asign_credenciales">
                        <div class="col-12 col-md-6 col-lg-4">
                            <label for="email">Correo electrónico</label>
                            <div class="input-group mb-3">
                                <input type="email" name="email" id="email" class="form-control" value="{{ $admin_perfil->user->email }}">
                                <button class="border rounded-end px-2" style="background-color: #f6f6f6; color:#535353" type="button" id="btn_copiar_email"><i class="bi bi-clipboard-fill icono_copy_email"></i></button>
                            </div>
                            <div class="invalid-feedback">
                                El campo no puede estar vacío
