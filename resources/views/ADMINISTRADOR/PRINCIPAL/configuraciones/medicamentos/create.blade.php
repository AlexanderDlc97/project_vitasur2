...
{{-- Contenido --}}
<form method="POST" action="{{ route('admin-medicamentos.store') }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>
    @csrf
    <div class="container-fluid">   
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4 col-lg-3">
                        ...
                        <input name="codigo" id="codigo__id" type="text" class="form-control" value="{{ old('codigo') }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <select name="tipo_producto" id="tipo_producto_id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            <option value="{{ old('clasificacion_id') }}" selected="selected" hidden="hidden">{{ old('clasificacion_id') }}</option>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <input name="marca" id="marca__id" type="text" class="form-control" value="{{ old('marca') }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <input name="cantidad" id="cantidad__id" type="number" class="form-control" value="{{ old('cantidad') }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <label for="precio_venta__id">Precio<span class="text-danger">*</span></label>
                        <input name="precio_venta" id="precio_venta__id" type="decimal" class="form-control" value="{{ old('precio_venta') }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
