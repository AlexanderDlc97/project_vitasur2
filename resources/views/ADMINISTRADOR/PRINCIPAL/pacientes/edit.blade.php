...
{{-- Contenido --}}
<form method="POST" action="{{ route('admin-pacientes.update',$admin_paciente->slug) }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>
    @csrf
    @method('put')
    <div class="container-fluid">   
            ...
            <div class="card-body">
                <div class="row g-3 mb-3">
                    <div class="col-12 col-md-3 col-lg-2 order-2 order-md-1">
                        <img for="uploadImage1" id="uploadPreview1" alt="" class="rounded imagecard" src="/images/personas/{{ $admin_paciente->imagen }}">   
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-2 col-lg-2">
                        ...
                        <input name="nro_identificacion" id="nro_identificacion_id" type="number" class="form-control" value="{{ $admin_paciente->nro_identificacion }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-5 col-lg-5">
                        ...
                        <input name="name" id="name_id" type="text" class="form-control" value="{{ $admin_paciente->name }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-5 col-lg-5">
                        ...
                        <input name="surnames" id="surnames_id" type="text" class="form-control" value="{{ $admin_paciente->surnames }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <select name="identificacion" id="identificacion__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            @foreach($identificaciones as $identificacion)
                                <option value="{{ $identificacion->abreviatura }}" @if( $admin_paciente->identificacion == $identificacion->abreviatura) selected="selected" @endif>{{ $identificacion->name }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <input name="nro_contacto" id="nro_contacto_id" type="number" class="form-control" value="{{ $admin_paciente->nro_contacto }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <label for="fecha_nacimiento_id">Fecha de Nacimiento</label>
                        <input name="fecha_nacimiento" id="fecha_nacimiento_id" type="date" class="form-control" value="{{ $admin_paciente->fecha_nacimiento }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <select name="sexo" id="sexo__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            <option value="Hombre" @if( $admin_paciente->sexo == "Hombre") selected="selected" @endif>Hombre</option>
                            <option value="Mujer" @if( $admin_paciente->sexo == "Mujer") selected="selected" @endif>Mujer</option>
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <select name="estado_civil" id="estado_civil__id" class="form-select select2_bootstrap" data-placeholder="Seleccione" required>
                            <option value="Soltero" @if( $admin_paciente->estado_civil == "Soltero") selected="selected" @endif>Soltero</option>
                            <option value="Casado" @if( $admin_paciente->estado_civil == "Casado") selected="selected" @endif>Casado</option>
                            <option value="Divorciado" @if( $admin_paciente->estado_civil == "Divorciado") selected="selected" @endif>Divorciado</option>
                            <option value="Viudo" @if( $admin_paciente->estado_civil == "Viudo") selected="selected" @endif>Viudo
                            <option value="Conviviente" @if( $admin_paciente->estado_civil == "Conviviente") selected="selected" @endif>Conviviente</option>
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5">
                        <label for="ocupacion__id">Ocupación</label>
                        <input name="ocupacion" id="ocupacion__id" type="text" class="form-control" value="{{ $admin_paciente->paciente->ocupacion }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-5">
                        <label for="responsable__id">Responsable</label>
                        <input name="responsable" id="responsable__id" type="text" class="form-control" value="{{ $admin_paciente->paciente->responsable }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-5">
                        <label for="direccion_id">Dirección<span class="text-danger">*</span></label>
                        <input name="direccion" id="direccion_id" type="text" class="form-control" value="{{ $admin_paciente->direccion }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-5">
                        ...
                        <input name="referencia" id="referencia__id" type="text" class="form-control" value="{{ $admin_paciente->referencia }}">
                    </div>
                    <div class="col-12 col-md-6 col-lg-2">
                        <label for="historia_clinica__id">Historia clínica<span class="text-danger">*</span></label>
                        <input name="historia_clinica" id="historia_clinica__id" type="text" class="form-control" value="{{ $admin_paciente->paciente->historia_clinica }}">
                    </div>
                </div>
