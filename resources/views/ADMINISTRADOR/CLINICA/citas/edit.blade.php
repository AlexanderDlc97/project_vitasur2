...
{{-- Contenido --}}
<form method="POST" action="{{ route('admin-citas.update',$admin_cita->slug) }}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate>
    @csrf
    @method('put')
    <div class="container-fluid">   
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4 col-lg-3">
                        ...
                        <input id="codigo__id" type="text" class="form-control bg-white" value="{{ $admin_cita->codigo }}" disabled>
                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        ...
                        <input name="fecha" id="fecha__id" type="date" class="form-control" value="{{ $admin_cita->fecha }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-3">
                        ...
                        <input name="hora" id="hora__id" type="time" class="form-control" value="{{ $admin_cita->hora }}" required>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-3">
                        ...
                        <select name="duracion" id="duracion__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            <option value="15" @if( $admin_cita->duracion == "15") selected="selected" @endif>15 minutos</option>
                            <option value="30" @if( $admin_cita->duracion == "30") selected="selected" @endif>30 minutos</option>
                            <option value="45" @if( $admin_cita->duracion == "45") selected="selected" @endif>45 minutos</option>
                            <option value="60" @if( $admin_cita->duracion == "60") selected="selected" @endif>60 minutos</option>
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        ...
                        <select name="paciente_id" id="paciente__id" class="form-select select2_bootstrap" data-placeholder="Seleccione" required>
                            @foreach($pacientes as $paciente)
                                <option value="{{ $paciente->id }}" @if( $admin_cita->paciente_id == $paciente->id) selected="selected" @endif>{{ $paciente->persona->name.' '.$paciente->persona->surnames }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        ...
                        <select id="especialidad__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            @foreach($especialidades as $especialidad)
                                <option value="{{ $especialidad->id }}_{{ $especialidad->profesione_id }}" @if( $admin_cita->especialidad_id == $especialidad->id) selected="selected" @endif>{{ $especialidad->name }}</option>
                            @endforeach
                        </select>
                        <input hidden name="especialidad_id" value="{{$admin_cita->especialidad_id}}" id="especilida_value_id">
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        ...
                        <select name="medico_id" id="medico__id" class="form-select select2_bootstrap_2" data-placeholder="Seleccione" required>
                            @foreach($medicos as $medico)
                                <option value="{{ $medico->id }}" @if( $admin_cita->medico_id == $medico->id) selected="selected" @endif>{{ $medico->persona->name.' '.$medico->persona->surnames }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <textarea name="descripcion" class="form-control" id="editor" rows="5">{!! $admin_cita->descripcion !!}</textarea>
                        <div class="invalid-feedback">
                            El campo no puede estar vacío
                        </div>
                    </div>
...
<script>
    $('#especialidad__id').on('change', function(){
        ...
        $.get('/busqueda_profesion',{value_especial: value_especial[1]}, function(busqueda){
            $('#medico__id').empty("");
            $('#medico__id').append("<option>Selecciona una opcion</option>");
