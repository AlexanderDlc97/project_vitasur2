                ...
                <div class="pb-2">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        @if(Auth::user()->role_id == '6')
                            <div class="col-12 col-md-12 col-lg-12">
                                <textarea name="descripcion_rx" class="form-control" id="editor" rows="5">
                                    @if($valor_rx != '')
                        ...
                        @else
                            <div class="col-12 col-md-12 col-lg-12">
                                <textarea name="descripcion_rx" class="form-control form-control-sm bg-white" disabled rows="5">
                                    @if($valor_rx != '')
                                        {!!$valor_rx->descripcion_rx!!}
                                    @else
                                    @endif
